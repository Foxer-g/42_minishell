...
EXEC_FILES = cmd_handler.c entrypoint.c expand_core.c expand_utils.c handling_utils.c quote_utils.c
...
SOURCES = $(SRC_DIR)main.c $(SRC_DIR)utils.c $(SRC_DIR)signals.c $(EXEC_SOURCES) $(BUILTINS_SOURCES) $(PARSING_SOURCES) $(TOKENIZER_SOURCES) $(COMMAND_GEN_SOURCES) $(COMMAND_UTILS_SOURCES) $(SCHEDULER_SOURCES)
